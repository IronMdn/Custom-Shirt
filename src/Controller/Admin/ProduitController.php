...
class ProduitController extends ControllerAbstract
{
    ...
    public function listAction()//renvoie la vue list.html.twig' avec tous les produits (pour admin)
    {
    ...
    public function editAction($id = null)//cette méthode enregistre un nouveau produits ou met à jour un produit déjà
        //existant
    {

        $types = $this->app['type.repository']->findAllTypes();//on a besoin de types et tissus car ils font partie
        //de la table produit (voir la BD) et serons setter en objet produit en tant qu'objets (voir plus bas)
