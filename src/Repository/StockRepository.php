...
class StockRepository extends RepositoryAbstract//cette classe gère tous ce qui concerne le stock de produits
{

    public function getTable()//RepositoryAbstract aura besoin du nom de la table dans la BD pour effectuer une requete
    {
        return 'produit_taille';
    }

    //Pour récupérer les données de la tables produit_taill avec objets (voir 'buildFromArrayStock' plus bas)
...
EOS;
    ...
    public function save($produits, $id)//requete de sauvegarde ou mise à jour de stock
    {
